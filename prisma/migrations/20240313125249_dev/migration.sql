/*
  ...
  - You are about to alter the column `registeredAt` on the `FanActuators` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
  ...
  - You are about to alter the column `registeredAt` on the `ProximitySensors` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
...
*/
-- AlterTable
ALTER TABLE `FanActuators` MODIFY `registeredAt` DATETIME NOT NULL DEFAULT current_timestamp;
...
-- AlterTable
ALTER TABLE `ProximitySensors` MODIFY `registeredAt` DATETIME NOT NULL DEFAULT current_timestamp;
